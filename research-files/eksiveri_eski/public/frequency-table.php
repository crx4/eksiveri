      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            ...
            <a href="training-set.php" class="list-group-item"><span class="glyphicon glyphicon-tower" aria-hidden="true"></span> Eğitim Kümesi</a>
            <a href="frequency-table.php" class="list-group-item active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Sıklık Tablosu</a>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default">
                <div class="panel-heading">Kelime Sıklıkları</div>
                <table class="table">
                  <tr>
                    <th>
                      id
                  ...
                  <?php
                    try {
                      ...
                      foreach ( $db->query('SELECT * FROM words_frequency ORDER BY count DESC LIMIT 1000') as $row ) {
                        echo "<tr><td>".$row['id']."</td><td>".$row['word']."</td><td>".$row['count']."</td></tr>";
                      }
